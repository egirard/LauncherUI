...
![Root redirects to sign-in](./screenshots/chromium-linux/000-root-redirect.png)
...
![Launcher routes to sign-in when unauthenticated](./screenshots/chromium-linux/001-launcher-redirect.png)
